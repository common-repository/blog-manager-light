...
switch( $postMetaData['media_type'] ) {
  ...
  case 'slider':
    ...
    if( !in_array( $this->listOptions['template'], $mainSlider ) ) {
      ...
      if( !empty($imgLink) ) {
        ...
        $media_item = '
        <a href="'. esc_attr( $imgLink  ).'" class="otw-slider-image otw-media-container" data-width="'.esc_attr( $this->imageWidth ).'">
        ...
        $media_item = '
          <span class="otw-media-container">
            <img src="'.$this->otwImageCrop->resize( $imagePath['path'], $this->imageWidth, $this->imageHeight, $this->imageCrop, $this->imageWhiteSpaces, $this->imageBackground ).'" alt="" data-item="media" data-width="'.esc_attr( $this->imageWidth ).'">
            '.$iconHover.'
          </span>
        ';
  ...
  case 'img':
    ...
    if( !empty($imgLink) ) {
      $media_item = '
      <a href="'. esc_attr( $imgLink  ).'" class="otw-media-container" data-width="'.esc_attr( $this->imageWidth ).'">
        <img src="'.$this->otwImageCrop->resize( $imagePath['path'], $this->imageWidth, $this->imageHeight, $this->imageCrop, $this->imageWhiteSpaces, $this->imageBackground ).'" alt="">
        '.$iconHover.'
      </a>';
    } else {
