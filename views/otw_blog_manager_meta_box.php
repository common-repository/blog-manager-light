<?php
	$selectOptionData = array(
		...
		array(
			'value'	=> 'youtube',
			'text'	=> esc_html__('YouTube', 'otw_bml')
		),
		array(
			'value'	=> 'vimeo',
			'text'	=> esc_html__('Vimeo', 'otw_bml')
		),
		array(
			'value'	=> 'soundcloud',
			'text'	=> esc_html__('Sound Cloud', 'otw_bml')
		),
		array(
			'value'	=> 'img',
			'text'	=> esc_html__('Image', 'otw_bml')
		),
		array(
			'value'	=> 'slider',
			'text'	=> esc_html__('Slider', 'otw_bml')
		)
	);
...
<table class="form-table">
	<tbody>
		<!-- Select Drop Down -->
		<tr valign="top">
			<th scope="row"><label for="media_type"><?php esc_html_e('Choose Media Type', 'otw_bml');?></label></th>
			<td>
		...
		<tr valign="top" class="js-meta-youtube <?php echo $youtube;?>">
			<th scope="row"><label for="youtube_url"><?php esc_html_e('Enter YouTube URL', 'otw_bml');?></label></th>
			<td>
		...
		<tr valign="top" class="js-meta-vimeo <?php echo $vimeo;?>">
			<th scope="row"><label for="vimeo_url"><?php esc_html_e('Enter Viemo URL', 'otw_bml');?></label></th>
			<td>
		...
		<tr valign="top" class="js-meta-soundcloud <?php echo $soundcloud;?>">
			<th scope="row"><label for="soundcloud_url"><?php esc_html_e('Enter SoundCloud URL', 'otw_bml');?></label></th>
			<td>
		...
		<tr valign="top" class="js-meta-image <?php echo $img;?>">
			<th scope="row"><label for="img_upload"><?php esc_html_e('Select File', 'otw_bml');?></label></th>
			<td>
				<a href="#" class="js-add-image"><?php esc_html_e('Add File', 'otw_bml');?></a>
		...
		<tr valign="top" class="js-meta-slider <?php echo $slider;?>">
			<th scope="row"><label for="slider"><?php esc_html_e('Slider Images', 'otw_bml');?></label></th>
			<td>
				<a href="#" class="js-add-image left"><?php esc_html_e('Add File', 'otw_bml');?></a><br/>
